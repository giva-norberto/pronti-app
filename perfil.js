// ======================================================================
//          PERFIL.JS (VERSÃO COMPLETA E CORRIGIDA, SEM REMOVER NADA)
// ======================================================================
...
// ===================================================================
// A lógica principal agora está dentro de um setTimeout para garantir
// que a sessão do userService.js seja lida da memória primeiro.
window.addEventListener('DOMContentLoaded', () => {
    setTimeout(() => {
        ...
        // Este onAuthStateChanged é mantido para garantir que a página reaja a mudanças de login,
        // mas a verificação de acesso inicial é a mais importante.
        onAuthStateChanged(auth, async (user) => {
            if (user) {
                ...
                try {
                    ...
                    if (acesso.role && acesso.role !== "dono" && acesso.role !== "admin") {
                    ...
                    if (e.message === 'primeiro_acesso') {
                        await carregarDadosDaPagina(user.uid);
                        adicionarListenersDeEvento();
                    } else if (!e.message.includes("Redirecionando")) {
                        console.error("Erro fatal no perfil.js:", e.message);
        ...
        // --- FUNÇÕES PRINCIPAIS (SEU CÓDIGO ORIGINAL, INALTERADO) ---
...
Você ganhou <strong>15 dias grátis</strong>!";
        ...
        // --- FUNÇÕES DE UI E EVENTOS (SEU CÓDIGO ORIGINAL, INALTERADO) ---
    ...
    }, 100); // Atraso de 100ms para estabilidade
});

...
import { getAuth, onAuthStateChanged } from "./firebase-config.js"; // Importa de firebase-config.js
...
// VARIÁVEL DE ESTADO
let empresaId = null;
let unsubProfissionais = null; // Para desligar o "ouvinte" em tempo real
...
/**
 * Inicia o "ouvinte" em tempo real para carregar e atualizar a lista de profissionais.
 */
...
/**
 * Renderiza a lista de profissionais (equipe) na tela.
...
function renderizarEquipe(equipe) {
    ...
    listaProfissionaisPainel.innerHTML = ''; // Limpa a lista antes de redesenhar
...
// OUVINTE PARA SALVAR O NOVO PROFISSIONAL
...
// PONTO DE PARTIDA: VERIFICAR AUTENTICAÇÃO

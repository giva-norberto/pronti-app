...
// ============================================================================
// CALLABLES DA FILA INTELIGENTE
// ============================================================================
exports.ofertarVagaParaFila = ofertarVagaParaFila;
exports.processarOfertasExpiradas = processarOfertasExpiradas;
...
exports.enviarNotificacaoFCM = onDocumentCreated(
  ...
  async (event) => {
    const bilhete = event.data?.data ? event.data.data() : null;
    const bilheteId = event.params?.bilheteId || null;
    ...
    return db.runTransaction(async (transaction) => {
      ...
      const telefoneWhatsapp =
        bilheteAtualizado.telefone || bilheteAtualizado.whatsapp || null;

 ...
 * descoberta através da análise dos logs de erro '5 NOT_FOUND'.
 */
...
// =================================================================================
// ENDPOINT 1: getStatusEmpresa (COM A CORREÇÃO 'empresarios')
// =================================================================================
...
// =================================================================================
// DEMAIS FUNÇÕES (Revisadas para consistência)
// =================================================================================
...
exports.createPreference = functions.https.onRequest((req, res ) => {
  corsHandler(req, res, async () => {
    ...
    try {
      ...
      // Assumindo que 'userId' aqui é o ID do dono da empresa, que também é o ID do documento em 'empresarios'
      ...
      // REVISADO: Garantindo que a coleção 'empresarios' seja usada aqui também.
...
exports.receberWebhookMercadoPago = functions.https.onRequest(async (req, res ) => {
  // ... (Esta função usa collectionGroup, então não precisa do nome da coleção. Está OK) ...
...
function calcularPreco(totalFuncionarios) {
  // ... (Sua função de cálculo de preço, sem alterações, está OK) ...

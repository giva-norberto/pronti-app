...
// ✅ CORREÇÃO: Adiciona o import que estava faltando para a função de notificação.
...
// ✅ CORREÇÃO: Usa a forma padrão de inicializar o Firestore, que evita o erro 404.
...
// ✅ FUNÇÃO DE NOTIFICAÇÃO ADICIONADA E CORRIGIDA
// ============================================================================
exports.enviarNotificacaoFCM = onDocumentCreated(
  {
    document: "filaDeNotificacoes/{bilheteId}",
    // ✅ CORREÇÃO DEFINITIVA: Especifica o database '(default)' para resolver o erro 404.
    database: "(default)",
  ...
  async (event) => {
    ...
    try {
      ...
      // ✅ CORREÇÃO: Atualiza o status do 'bilhete' após o envio.
